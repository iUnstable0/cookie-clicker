...
export default function Home() {
	...
	const [pendingJumpscare, setPendingJumpscare] = useState<boolean>(false);
	...
	const [playDamage] = useSound("/sounds/hit.mp3", {
		volume: 1,
		interrupt: false,
	});
	...
	const damage = useCallback((instant: boolean) => {
		if (instant) {
			playDamage();
		} else {
			setTimeout(() => {
	...
	}, [gameStarted, isHaunted, pendingJumpscare, damage, playJumpscare]);
